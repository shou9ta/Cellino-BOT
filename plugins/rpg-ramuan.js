...
`.trim()
                     ...
                     break
                     case 'iron':
                                     let emasbiasa = global.db.data.users[m.sender].emasbiasa
                                     ...
                                     global.db.data.users[m.sender].emasbiasa -= emasbiasak * 1
...
`.trim()
                          ...
                          } else m.reply(`Pastikan emasbiasa kamu *5* untuk bisa meracik iron`)
...
`.trim()
                     ...
                     break
                           default:
                                  return conn.reply(m.chat, `${usedPrefix + command} [ramuan | potion | string | iron | sword | pancingan]\nContoh penggunaan: *${usedPrefix + command} ramuan*`, m)
                           }
                        }
